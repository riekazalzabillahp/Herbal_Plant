...
class ResultActivity : AppCompatActivity() {
    ...
    lateinit var tanaman: Array<String>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tanaman = intent.getStringArrayExtra("RESULT") as Array<String>
        binding.tvNamaTanaman.text = tanaman[0]
        binding.tvManfaatTanaman.text = tanaman[1]
        binding.tvCaraOlah.text = tanaman[2]

        val img = this.getResources().getIdentifier(tanaman[3], "drawable", this.getPackageName())
        binding.HerbalImage.setImageResource(img)
